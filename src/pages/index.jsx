  ...
  <React.Fragment>
    ...
    <Parallax pages={4}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> I'm Joe Mordica.
          </BigTitle>
          <Subtitle>Dabbler of software, design, tech, business, leadership, and fun.</Subtitle>
        </Hero>
      </Content>
      ...
      <Content speed={0.4} offset={1}>
        <Inner>
          ...
          <ProjectsWrapper>
            ...
            >
              What a great honor it is to be surrounded daily by such awesome people.
            </ProjectCard>
            <ProjectCard
            ...
            <ProjectCard
              title="VERT"
              link="https://flyvert.us"
              bg="linear-gradient(to right, #009245 0%, #FCEE21 100%)"
            >
              We are helping re-invent the way people travel in the air.
            </ProjectCard>
            <ProjectCard
              title="Landshark"
              link="https://landsharkmascot.com/"
              bg="linear-gradient(to right, #D585FF 0%, #00FFEE 100%)"
            >
              Really fun project that got some good and bad press!
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={2}>
        <Inner>
          <Title>About</Title>
          <AboutHero>
            <Avatar src={avatar} alt="Joe Mordica" />
            <AboutSub>
              I'm a child of God, father, husband, and dabbler of all things business. I love building relationships and connecting with people in very unique circumstances architected by God.
            </AboutSub>
          </AboutHero>
          <AboutDesc>
            I was put here on earth to serve God and carry out the mission that he has trusted me with. I'm always looking for ways to grow and lead my family and people that I've been trusted to help. I don't want my life to follow worthless pursuit, but instead enjoy the residual reward and joy of knowing I was able to inspire others to dig deeper and find/use their gifts to pursue their purpose and mission given to them by God.
          </AboutDesc>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:jmordica@gmail.com">Hi</a> or find me on other platforms:{' '}
            <a href="https://twitter.com/jmordica">Twitter</a> &{' '}
            <a href="https://github.com/jmordica">Github</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2018 by Joe Mordica.{' '}
          <a href="https://jmordica.com">jmordica.com</a>
        </Footer>
      </Content>
